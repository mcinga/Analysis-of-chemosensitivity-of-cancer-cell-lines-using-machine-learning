...
gdsc_09<-gdsc_09 %>%
  ...
  slice(min(2, n()))%>%dplyr::rename(DOSE_RESPONSE=LN_IC50)%>%
  select(-c(BIOACTIVITY,Z_SCORE))%>%
  ungroup
...
GDSC_09<-data_relocate(gdsc_09, select = "DOSE_RESPONSE", before = "CELL_LINE_NAME")
GDSC_09<-data_relocate(GDSC_09, select = "PATHWAY_NAME", before = "DRUG_NAME")

GDSC_08<-data_relocate(gdsc_08, select = "DOSE_RESPONSE", before = "CELL_LINE_NAME")
GDSC_08<-data_relocate(GDSC_08, select = "PATHWAY_NAME", before = "DRUG_NAME")

GDSC_07<-data_relocate(gdsc_07, select = "DOSE_RESPONSE", before = "CELL_LINE_NAME")
GDSC_07<-data_relocate(GDSC_07, select = "PATHWAY_NAME", before = "DRUG_NAME")

GDSC_06<-data_relocate(gdsc_06, select = "DOSE_RESPONSE", before = "CELL_LINE_NAME")
GDSC_06<-data_relocate(GDSC_06, select = "PATHWAY_NAME", before = "DRUG_NAME")

GDSC_05<-data_relocate(gdsc_05, select = "DOSE_RESPONSE", before = "CELL_LINE_NAME")
GDSC_05<-data_relocate(GDSC_05, select = "PATHWAY_NAME", before = "DRUG_NAME")

GDSC_04<-data_relocate(gdsc_04, select = "DOSE_RESPONSE", before = "CELL_LINE_NAME")
GDSC_04<-data_relocate(GDSC_04, select = "PATHWAY_NAME", before = "DRUG_NAME")

GDSC_03<-data_relocate(gdsc_03, select = "DOSE_RESPONSE", before = "CELL_LINE_NAME")
GDSC_03<-data_relocate(GDSC_03, select = "PATHWAY_NAME", before = "DRUG_NAME")

GDSC_02<-data_relocate(gdsc_02, select = "DOSE_RESPONSE", before = "CELL_LINE_NAME")
GDSC_02<-data_relocate(GDSC_02, select = "PATHWAY_NAME", before = "DRUG_NAME")

GDSC_01<-data_relocate(gdsc_01, select = "DOSE_RESPONSE", before = "CELL_LINE_NAME")
...
GDSC_09_CRISPR<-data_relocate(GDSC_09_CRISPR, select= "DOSE_RESPONSE", before = "CELL_LINE_NAME")
GDSC_08_CRISPR<-data_relocate(GDSC_08_CRISPR, select= "DOSE_RESPONSE", before="CELL_LINE_NAME")
GDSC_07_CRISPR<-data_relocate(GDSC_07_CRISPR, select= "DOSE_RESPONSE",before = "CELL_LINE_NAME") 
GDSC_06_CRISPR<-data_relocate(GDSC_06_CRISPR, select= "DOSE_RESPONSE", before="CELL_LINE_NAME")
GDSC_05_CRISPR<-data_relocate(GDSC_05_CRISPR, select ="DOSE_RESPONSE", before = "CELL_LINE_NAME")
GDSC_04_CRISPR<-data_relocate(GDSC_04_CRISPR, select= "DOSE_RESPONSE", before = "CELL_LINE_NAME")
GDSC_03_CRISPR<-data_relocate(GDSC_03_CRISPR, select= "DOSE_RESPONSE", before="CELL_LINE_NAME")
GDSC_02_CRISPR<-data_relocate(GDSC_02_CRISPR, select= "DOSE_RESPONSE",before = "CELL_LINE_NAME") 
GDSC_01_CRISPR<-data_relocate(GDSC_01_CRISPR, select= "DOSE_RESPONSE", before="CELL_LINE_NAME")

#CONVERTING ALL THE CHARACTERS INTO NUMERICALS FOR REGRESSION ANALYSIS.

#FINDING THE DIMENSIONS
unique(GDSC_05_CRISPR$CELL_LINE_NAME)
unique(GDSC_05_CRISPR$DRUG_NAME)

write_csv(GDSC_09_CRISPR,"GDSC_09_CRISPR_reg.csv")
write_csv(GDSC_08_CRISPR,"GDSC_08_CRISPR_reg.csv")
write_csv(GDSC_07_CRISPR,"GDSC_07_CRISPR_reg.csv")
write_csv(GDSC_06_CRISPR,"GDSC_06_CRISPR_reg.csv")
write_csv(GDSC_05_CRISPR,"GDSC_05_CRISPR_reg.csv")
write_csv(GDSC_04_CRISPR,"GDSC_04_CRISPR_reg.csv")
write_csv(GDSC_03_CRISPR,"GDSC_03_CRISPR_reg.csv")
write_csv(GDSC_02_CRISPR,"GDSC_02_CRISPR_reg.csv")
write_csv(GDSC_01_CRISPR,"GDSC_01_CRISPR_reg.csv")
